...
<div class="bigbox">
   ...
   <li><a href="index.php">推荐</a></li>
    ...
    <li><a href="2dashuju.php" style="background-color:#cc0000">大数据</a></li>
    ...
    <div id="section">
        <div id="myFocus"><!--焦点图盒子-->
           <div class="loading"></div>
            ...
            <div class="pic"><!--图片列表-->
              <ul>
               <li><a href="#1"><img src="img/6.png" thumb=""/></a></li>
                <li><a href="#2"><img src="img/7.png" thumb=""/></a></li>
                <li><a href="#3"><img src="img/8.png" thumb=""/></a></li>
                <li><a href="#4"><img src="img/9.png" thumb=""/></a></li>
                <li><a href="#5"><img src="img/10.png" thumb=""/></a></li>
              </ul>
            </div>
          </div>
        </div>	
