...
<div class="bigbox">
   ...
   <li><a href="index.php">推荐</a></li>
    ...
    <li><a href="2youxikaifa.php" style="background-color:#cc0000">游戏开发</a></li>
    <li><a href="2qianduan.php">前端</a></li>
    <li><a href="2yunwei.php">运维</a></li>
    <li><a href="2dashuju.php">大数据</a></li>
    <li><a href="2jisuanjijichu.php">计算机基础</a></li>
    <li><a href="2qita.php">其他</a></li>
    </ul>
    </div>
    ...
    <div id="section">
        <div id="myFocus"><!--焦点图盒子-->
           <div class="loading"></div>
            ...
            <div class="pic"><!--图片列表-->
              <ul>
                <li><a href="#1"><img src="img/16.png" thumb=""/></a></li>
                <li><a href="#2"><img src="img/17.png" thumb=""/></a></li>
                <li><a href="#3"><img src="img/18.png" thumb=""/></a></li>
                <li><a href="#4"><img src="img/19.png" thumb=""/></a></li>
                <li><a href="#5"><img src="img/20.png" thumb=""/></a></li>
              </ul>
            </div>
          </div>
        </div>	
...
4、半路出家，能不能成为大牛我不清楚，最好在付出前不要在意结果，难道因为吃鱼有1%的几率卡喉，你就一辈子不吃了？成不了大牛，就不学编程了？如果你的对象一开始不能答应你白头偕老，你就不谈恋爱了
      ...
      高考是我们人生中的一件大事，每一次的选择可能都会将我们指引向不同的方向，引导到不同的人生上，每一次人生选择的时候，若能跟上时代前进的步伐，或许后续就会走向不同的人生轨迹。</br></p>
              <p class="autor"><span class="lm f_l"><a href="/">MyBlog</a></span><span class="dtime f_l">2014-02-19</span>
              <span class="pingl f_r">评论（<a href="/">30</a>）</span></p>
            </ul>
          </div>
...
　</p>
          ...
          <div class="blogs">
            ...
            <ul>
              ...
              <p>所谓界面测试就是指，布局是否合理、整体风格是否一致、各个控件的放置位置是否符合客户使用习惯，此外还要测试界面操作便捷性、导航简单易懂性，页面元素的可用性，界面中文字是否正确，命名是否统一，页面是否美观，文字、图片组合是否完美等。</br>一般情况下我们进行界面测试，直接依据产品原型图以及UI切图/效果图，进行对比验证，确认是否一致。 但是如果碰到公司没有原型图，没有UI效果图怎么破？ 毕竟同是天涯沦落人的情况太多了~~</br>那么我们可以参考市场上同类型的成熟产品来做界面比对.</p>
              <p class="autor"><span class="lm f_l"><a href="/">MyBlog</a></span><span class="dtime f_l">2014-02-19</span>
              <span class="pingl f_r">评论（<a href="/">30</a>）</span></p>
            </ul>
          </div>
