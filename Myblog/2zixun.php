...
<div class="bigbox">
   ...
   <li><a href="index.php" >推荐</a></li>
    ...
    <li><a href="2zixun.php"style="background-color:#cc0000">资讯</a></li>
    ...
    <div id="section">
        <div id="myFocus"><!--焦点图盒子-->
           <div class="loading"></div>
            ...
            <div class="pic"><!--图片列表-->
              <ul>
                 <li><a href="#1"><img src="img/26.png" thumb=""/></a></li>
                <li><a href="#2"><img src="img/27.png" thumb=""/></a></li>
                <li><a href="#3"><img src="img/28.png" thumb=""/></a></li>
                <li><a href="#4"><img src="img/29.png" thumb=""/></a></li>
                <li><a href="#5"><img src="img/30.png" thumb=""/></a></li>
              </ul>
            </div>
          </div>
        </div>	
