...
<div class="bigbox">
   ...
   <li><a href="index.php" >推荐</a></li>
    ...
    <li><a href="2jisuanjijichu.php"style="background-color:#cc0000">计算机基础</a></li>
    ...
    <div id="section">
        <div id="myFocus"><!--焦点图盒子-->
           <div class="loading"></div>
            ...
            <div class="pic"><!--图片列表-->
              <ul>
                <li><a href="#1"><img src="img/2.png" thumb=""/></a></li>
                <li><a href="#2"><img src="img/4.png" thumb=""/></a></li>
                <li><a href="#3"><img src="img/8.png" thumb=""/></a></li>
                <li><a href="#4"><img src="img/25.png" thumb=""/></a></li>
                <li><a href="#5"><img src="img/17.png" thumb=""/></a></li>
              </ul>
            </div>
          </div>
        </div>	
