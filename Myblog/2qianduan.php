...
<div class="bigbox">
   ...
   <li><a href="index.php">推荐</a></li>
    ...
    <li><a href="2qianduan.php" style="background-color:#cc0000">前端</a></li>
           ...
           <div class="loading"></div>
            ...
            <div class="pic"><!--图片列表-->
              <ul>
                ...
                <li><a href="#4"><img src="img/6.png" thumb=""/></a></li>
                <li><a href="#5"><img src="img/33.png" thumb=""/></a></li>
              </ul>
            </div>
          </div>
        </div>	
