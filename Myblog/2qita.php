...
<div class="bigbox">
   ...
   <li><a href="index.php" >推荐</a></li>
    ...
    <li><a href="2qita.php"style="background-color:#cc0000">其他</a></li>
    </ul>
    </div>
    ...
    <div id="section">
        <div id="myFocus"><!--焦点图盒子-->
           <div class="loading"></div>
            ...
            <div class="pic"><!--图片列表-->
              <ul>
                <li><a href="#1"><img src="img/11.png" thumb=""/></a></li>
                <li><a href="#2"><img src="img/12.png" thumb=""/></a></li>
                <li><a href="#3"><img src="img/13.png" thumb=""/></a></li>
                <li><a href="#4"><img src="img/14.png" thumb=""/></a></li>
                <li><a href="#5"><img src="img/15.png" thumb=""/></a></li>
              </ul>
            </div>
          </div>
        </div>	
